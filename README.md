...
| 010~012 | 가계부 · 고정지출 · 목표·통계 화면 13건 | 예정 |

009 까지 끝나 **화면 18건이 서고, 가입에서 수단·지출유형 관리까지 화면으로 끝까지 돈다.**
009 가 세운 **목록 하나에 모달 셋**이라는 모양을 010~012 의 목록 화면들이 따라간다. 로그인 뒤
착지하는 월별 가계부(`/ledger`)는 010 이 만든다.
