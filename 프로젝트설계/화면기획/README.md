...
올릴 파일: [`figma/png/`](./figma/png/) · 안내: [`figma/README.md`](./figma/README.md)

1. `figma/png/` 안의 `.png`를 선택한다.
2. Figma **캔버스**에 **끌어다 놓는다.** (`Ctrl + Shift + K`도 가능)
3. **PDF는 Figma에 넣지 않는다.** (지원 안 함)

| 프로토 | 대응 화면 |
|--------|-----------|
| `auth-login.html` | 1.1 |
| `auth-signup.html` | 1.2 |
| `auth-find-id.html` | 1.3 |
| `auth-find-password.html` | 1.4 |
| `auth-reset-password.html` | 1.5 |
