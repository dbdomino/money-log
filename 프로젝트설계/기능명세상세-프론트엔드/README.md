...
현재 **Phase 1 회원 화면 10건이 전부 완료**, 나머지 21개는 **골격**이다.

1.6 권한 없음은 007 공통 기반이 먼저 세웠다 — 권한 차단이 착지할 곳이 없으면 진입 판정을
완성할 수 없고, 이 화면만 백엔드를 부르지 않아 다른 화면과 성격이 다르다. 나머지 9건(1.1~1.5 ·
1.7~1.10)은 008 이 채웠다. Phase 2~6 의 21개는 009~012 가 자기 범위의 문서를 채운다.
