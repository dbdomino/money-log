...
현재 **Phase 1 회원 화면 10건과 Phase 2 수단·지출유형 화면 8건이 완료**, 나머지 13개는 **골격**이다.

1.6 권한 없음은 007 공통 기반이 먼저 세웠다 — 권한 차단이 착지할 곳이 없으면 진입 판정을
완성할 수 없고, 이 화면만 백엔드를 부르지 않아 다른 화면과 성격이 다르다. Phase 1 의 나머지
9건(1.1~1.5 · 1.7~1.10)은 008 이, Phase 2 의 8건(2.1~2.8)은 009 가 채웠다. Phase 3~6 의
13개는 010~012 가 자기 범위의 문서를 채운다.

**009 가 목록 하나에 모달 셋이라는 모양을 굳혔다.** 2.1~2.4 와 2.5~2.8 이 같은 모양이며,
010~012 의 목록 화면들이 그것을 따른다. 공통 규칙은 [_공통.md](./_공통.md) 에 있다.
