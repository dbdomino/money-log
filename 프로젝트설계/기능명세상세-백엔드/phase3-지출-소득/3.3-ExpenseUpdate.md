...
> API: `ExpenseUpdate` · Phase 3 · 기능번호 3.3  
...
| 1001 | 로그인 필요 |
| 3202 | 지출 없음 |
| 3201 | 보낸 값의 오류 — 금액이 0 이하·정수 아님, 날짜가 `YYYY-MM-DD` 아님, 장소 100자·내용 255자 초과 |
| 3203 | 할부 **개월·시작월** 변경 시도 (불가) |
| 3003 | 수단 없음·타인 소유·**사용 안 함**·**삭제 표시**·**용도 불일치** — 수단을 **바꿀 때만** 본다 |
| 3103 | 지출유형 없음·타인 소유·**사용 안 함**·**삭제 표시** — 유형을 **바꿀 때만** 본다 |
| 9001 | 잘못된 요청 |
