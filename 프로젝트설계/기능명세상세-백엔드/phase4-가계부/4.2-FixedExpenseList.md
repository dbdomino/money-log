...
> API: `FixedExpenseList` · Phase 4 · 기능번호 4.2  
...
| 필드 | 타입 | 설명 |
|------|------|------|
| `list` | array (object[]) | FixedExpense 목록. 각 요소는 FixedExpense 전체 + `paymentMethodName`·`expendGroupName`이며 두 이름은 모두 **현재** 값이다(스냅샷 아님, 4.1·4.3과 같은 규칙) |
