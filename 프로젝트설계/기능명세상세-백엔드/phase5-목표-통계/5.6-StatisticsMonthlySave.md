...
> API: `StatisticsMonthlySave` · Phase 5 · 기능번호 5.6  
...
| 3604 | 저장 대상 연·월이 **현재 연월을 초과**함. 이번 달은 저장할 수 있다 |
...
- 저장 후 기본 `StatisticsMonthlyGet`(view 생략)은 `source=SAVED` 반환. 최신과 비교하려면 `?view=live`.
