...
> API: `MemberResetPassword` · Phase 1 · 기능번호 1.11  
> 인덱스: [README.md](../README.md)  
> 선행: [1.10 비밀번호 찾기](./1.10-MemberFindPassword.md)
...
- **[1.10 비밀번호 찾기](./1.10-MemberFindPassword.md) 성공 후** 호출하는 재설정 API이다.
...
- 로그인 상태에서 프로필로 바꾸는 경우는 [1.8 본인 정보 수정](./1.8-MemberUpdateMe.md) (`password`는 선택).
