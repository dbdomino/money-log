# [백엔드] 로그아웃 (JWT Token 비활성화)

> API: `MemberTokenRevoke` · Phase 1 · 기능번호 1.6  
...
- 관련: [1.4 토큰 검증](./1.4-MemberTokenValidate.md) · [1.5 토큰 갱신](./1.5-MemberTokenRefresh.md) · [_인증·토큰 공통](./_인증-토큰.md)
