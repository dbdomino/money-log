...
> API: `MemberFindPassword` · Phase 1 · 기능번호 1.10  
> 인덱스: [README.md](../README.md)  
> 이어지는 기능: [1.11 비밀번호 변경](./1.11-MemberResetPassword.md)
...
- 성공 후 프론트는 [1.11 비밀번호 변경](./1.11-MemberResetPassword.md) 화면으로 진행한다.
- 이메일 인증·보안질문 없음 (요구사항과 동일).
- 로그인 후 비밀번호 변경은 [1.8 본인 정보 수정](./1.8-MemberUpdateMe.md)의 `password` 필드.
