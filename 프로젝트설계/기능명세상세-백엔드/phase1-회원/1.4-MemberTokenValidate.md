...
> API: `MemberTokenValidate` · Phase 1 · 기능번호 1.4  
...
> 본인 상세 프로필(닉네임·이메일 등)은 [1.7 본인 정보 조회](./1.7-MemberGetMe.md)를 사용한다. 본 API는 **토큰·세션 유효성**만 확인한다.
...
- 관련: [1.3 로그인](./1.3-MemberLogin.md) · [1.5 토큰 갱신](./1.5-MemberTokenRefresh.md) · [1.6 로그아웃](./1.6-MemberTokenRevoke.md) · [_인증·토큰 공통](./_인증-토큰.md)
